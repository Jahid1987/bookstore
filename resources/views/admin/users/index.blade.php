  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="{{'http://localhost/englaa.com/storage/app/public/' . @$user->profile->thumbnail}}" alt="{{@$user->profile->name}}" class="img-responsive" height="50"/></td>
        @if($user->trashed())
        ...
        <form id="delete-user-{{$user->id}}" action="{{route('admin.profile.destroytrash', $user->id)}}" method="POST" style="display: none;">
