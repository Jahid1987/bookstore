...
<form  action="{{route('admin.profile.update', $user->profile->slug)}}" method="POST" accept-charset="utf-8" enctype="multipart/form-data"> 
	...
	<div class="row">
		...
		<div class="form-group row">
			<div class="col-sm-12">
				...
				<div class="input-group mb-3">
					<input type="text" name="address" placeholder="Address" class="form-control " value="{{@$user->profile->address}}"/>
				</div>
			</div>
		</div>
		<div class="form-group row">
		...
		<ul class="list-group row">
			...
			<li class="list-group-item">
				...
				<div class="img-thumbnail  text-center">
					<img src="{{'http://localhost/englaa.com/storage/app/public/' . @$user->profile->thumbnail}}" id="imgthumbnail" class="img-fluid" alt="">
				</div>
			</li>
			<li class="list-group-item">
				<div class="form-group row">
