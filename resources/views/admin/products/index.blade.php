  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>৳{{$product->price}}</td>
        <td><img src="{{'http://localhost/englaa.com/storage/app/public/' . $product->thumbnail}}" alt="{{$product->title}}" class="img-responsive" height="50"/></td>
        @if($product->trashed())
        ...
        <form id="delete-product-{{$product->id}}" action="{{ route('admin.product.destroytrash', $product->id, $product->slug) }}" method="POST" style="display: none;">
