		...
		<tbody>
			...
			@foreach($cart->getContents() as $slug => $product)
				...
				<tr>
					<td>
						<figure class="media">
							<div class="img-wrap"><img class="img-thumbnail img-fluid img-sm" src="{{'http://localhost/englaa.com/storage/app/public/'.$product['product']->thumbnail }}"></div>
					...
					<td>
						...
						<input type="submit" name="update" value="Update" class="btn btn-block btn-outline-success btn-round btn-sm">
						</form>
					</td>
					<td>
